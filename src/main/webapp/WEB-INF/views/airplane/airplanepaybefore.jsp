...
<body>
	<div
		id="Mrt3Payment-react-component-acae5f91-949c-443e-9eed-359aaa720e6d">
			...
			<form class="css-d4sm79--OrderFormBase--Form eyxr1170">
				...
				<div class="css-1ch2iob--OrderForm--Content ed3ree22">
					<div class="css-ttzwrq--OrderForm--Wrapper ed3ree21">
						<div
							class="css-19p5kql--OrderForm--CommonPurchaseContainer ed3ree20">
							<!--                   호텔정보   1번 div -->
							<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
								<div
									class="css-z4djww--SectionContainer--Body--ProductInfo--mainContentStyle exjt3m70">
									<!--                            호텔 이름 -->
									<div
										class="css-9e4tkg--ProductInfoSummary--Container e1m7creq3">
										<div
											class="css-n2xyg7--ProductInfoSummary--ImageWrapper e1m7creq2">
											<img src="${image}" alt="상품 이미지"
												class="css-170w93a--ProductInfoSummary--Image e1m7creq1">
										</div>
										<h3 class="css-1hgeeeb--ProductInfoSummary--Title e1m7creq0">${packageVo.title}</h3>
									</div>
									<!--                            체크인 -->
									<p
										class="css-18inzct--ProductInfoSchedule--ScheduleItem e4bh9q30">
										<span>출발일</span> <span>${  packageVo.start_date } </span>
									</p>
									<!--                            체크아웃 -->
									<p
										class="css-18inzct--ProductInfoSchedule--ScheduleItem e4bh9q30">
										<span>귀국일</span> <span>${ packageVo.end_date }</span>
									</p>
								</div>
							</div>
							<!--                   결제금액   2번 div -->
							<div
								class="css-jx2h8f--SectionContainer--Container--Price--containerStyle exjt3m71">
								<div
									class="css-10zndy8--SectionContainer--Body--Price--mainContentStyle exjt3m70">
									<ul class="css-v6wk68--PriceList--OptionWrapper ew0r5g20">
										<li class="css-1xtyir3--OptionInfoList--Option e1fd4fa03">
											<div class="css-81epwr--OptionInfoList--OptionText e1fd4fa01">
												<span
													class="css-16q01t6--OptionInfoList--OptionName e1fd4fa02">${packageVo.title}</span>
											</div>
											<div
												class="css-mnnvnj--OptionInfoList--OptionPrice e1fd4fa00">${package_price}원/1명</div>
										</li>
										<li class="css-qcgeyu--ExtraInfoList--Option el8p7f63">
											...
											<div class="css-17r2s3v--ExtraInfoList--OptionPrice el8p7f60">총
												${date}일</div>
										</li>
									</ul>
								</div>
							...
							<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
								<div
									class="css-13hdby9--SectionContainerHeader--Wrapper e1o4ti5r4">
									<div class="css-1m5d5b0--SectionContainerHeader--Box e1o4ti5r3">
										<h2
											class="css-1espa7k--SectionContainerHeader--Title e1o4ti5r2">포인트
											사용</h2>
									</div>
								</div>
								<hr class="css-73gmso">
								<div class="css-1xjf2qv--SectionContainer--Body exjt3m70">
									<div class="reservation-container">
										<label class="css-xht1av--re-style--label"
											for="reservationInput">예약자 수</label> <input type="number"
											id="reservationInput"
											class="reservation-input css-1iuiezq--re-style--holdingPoint"
											min="1" value="${reservation_su}" placeholder="명 수 입력">
									...
									<div class="css-dnxl79--Point-style--labelWrapper">
										<span class="css-xht1av--Point-style--label">내 포인트</span> <span
											class="css-1iuiezq--Point-style--holdingPoint">${point}원</span>
									</div>

									<div class="css-1ci03y3--Point-style--inputWrapper">
										<div class="checkout-point-inputbox css-1vqiqg7">
											<input type="number" id="pointsToUse" placeholder="0"
												pattern="[0-9]*" class="css-o9jzai" value="0"> <span
												class="css-1fwrkpi">원</span>
										</div>
							...
							<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
								<div
									...
									<div class="css-1m5d5b0--SectionContainerHeader--Box e1o4ti5r3">
										<h2
											class="css-1espa7k--SectionContainerHeader--Title e1o4ti5r2">예약자</h2>
									</div>
								</div>
								<hr class="css-73gmso">
								<div class="css-1xjf2qv--SectionContainer--Body exjt3m70">
									<div>
										<div
											class="css-1jsagqa--ReservationPerson--Container e1eynx4r2">
											<div class="css-cv06j6--EditForm--Container e1rcmy85">
												<div
													class="css-9yldiq--EditForm--KoreanNameWrapper e1rcmy84">
													<span
														class="css-119aw1b--EditForm--KoreanName--getEllipsisStyle--getEllipsisStyle e1rcmy83">${userInfo.last_name}
														${userInfo.first_name}</span> <img class="css-labkkb"
														src="https://dffoxz5he03rp.cloudfront.net/icons/ic_select_arrow_gray_1000.svg"
														alt="icon">
												</div>
												<div
													class="css-1qn2m1l--Email--Info--getEllipsisStyle--getEllipsisStyle e1tt4p4k0">${userInfo.email}</div>
												<div
													class="css-19x6daw--KorName--Info--getEllipsisStyle--getEllipsisStyle e1apmuge0">${userInfo.last_name}
												...
												<div class="css-14dhszq--EngName--Wrapper e212gkd0">
													<div
														class="css-mexqx--AdditionalInfoContainer--Container--AdditionalInfoContainer--Container e19vw12m2">
														<div
															class="css-txmszs--AdditionalInfoContainer--Label e19vw12m1">영문
															성</div>
														<input type="text" placeholder="HONG" maxlength="50"
															class="css-15wiu3z--EngLastName--TextInput e6e1ike1"
															value="">
													</div>
													<div
														class="css-mexqx--AdditionalInfoContainer--Container--AdditionalInfoContainer--Container e19vw12m2">
														<div
															class="css-txmszs--AdditionalInfoContainer--Label e19vw12m1">영문
															이름</div>
														<input type="text" placeholder="GILDONG" maxlength="50"
															class="css-yv1h8q--EngFirstName--TextInput e39z6rv1"
															value="">
													</div>
												</div>
										...
										<div
											class="css-19vy8jy--ReservationPerson--NoticeWrapper e1eynx4r1">
											<span
												class="css-1ibdkp7--ReservationPerson--Notice e1eynx4r0">예약
												안내 정보가 예약자의 이메일로 발송됩니다.</span>
										</div>
										<div class="css-kumkj--Companion--Container e1po6iqs2">
											<div class="css-2mpmz3--Companion--Title e1po6iqs1">누구와
												함께 떠나세요?</div>
											<div class="css-1mp7jgw--Companion--SubTitle e1po6iqs0">여행자님에게
												꼭 맞는 여행 상품을 추천해드릴게요</div>
											<div class="css-5suex">
							...
							<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
								<div
									...
									<div class="css-1m5d5b0--SectionContainerHeader--Box e1o4ti5r3">
										<h2
											class="css-1espa7k--SectionContainerHeader--Title e1o4ti5r2">추가
											예약 정보</h2>
										<span
											class="css-1mrjn5z--SectionContainerHeader--Required e1o4ti5r1">(선택)</span>
									</div>
								</div>
								<hr class="css-73gmso">
								<div class="css-1xjf2qv--SectionContainer--Body exjt3m70">
									<div
										class="css-13jamwz--PartnerCustomInfos--OptionWrapper e1sg07ai2">
										<div
											class="css-vjrmsf--PartnerCustomInfos--OptionTitle e1sg07ai1">기타
											요청 사항</div>
										<div
											class="css-q0yy64--AdditionalInfoContainer--Container e19vw12m2">
											<div
												class="css-txmszs--AdditionalInfoContainer--Label e19vw12m1">숙소에
												전달할 요청사항을 현지 언어로 작성해주세요.</div>
											<textarea maxlength="3000" placeholder="답변을 입력해 주세요."
												class="css-uqj3ax--TextArea--TextAreaInput e1xavf0v0"></textarea>
										</div>
										<div
											class="css-m52mdb--PartnerCustomInfos--GuideText e1sg07ai0">고객님의
											요청사항이 전달되나, 간혹 현장 사정에 따라 반영되지 않을 수 있습니다.</div>
									</div>
								</div>
							</div>
							<!--                      결제방법 6번 div-->
							<div>
								...
								<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
									<div
										class="css-13hdby9--SectionContainerHeader--Wrapper e1o4ti5r4">
										<div
											class="css-1m5d5b0--SectionContainerHeader--Box e1o4ti5r3">
											<h2
												class="css-1espa7k--SectionContainerHeader--Title e1o4ti5r2">결제
												방법</h2>
										</div>
									</div>
									<hr class="css-73gmso">
									<div class="css-1xjf2qv--SectionContainer--Body exjt3m70">
										<div class="css-1tu548c--PaymentBenefits--Container e14memtx0">
											<div role="button" tabindex="0">
												<div
													class="css-yojrs6--PaymentBenefitCollectionItem--Item e1t707xg0">
													<div
														class="css-1ye5zyg--PaymentBenefitCollectionItem--LogoWrapper e1t707xg1"></div>
													<div
														class="css-1j6vtio--PaymentBenefitCollectionItem--TextWrapper e1t707xg4">
														<p type="bold"
															class="css-cltgrd--PaymentBenefitCollectionItem--Text e1t707xg3">하나카드
															5% 즉시할인</p>
													</div>
												</div>
											</div>
											<div role="button" tabindex="0">
												<div
													...
													<div
														class="css-1j6vtio--PaymentBenefitCollectionItem--TextWrapper e1t707xg4">
														<p type="bold"
															class="css-cltgrd--PaymentBenefitCollectionItem--Text e1t707xg3">우리카드
															8% 청구 할인</p>
													</div>
												</div>
											</div>
											<div role="button" tabindex="0">
												<div
													...
													<div
														class="css-1j6vtio--PaymentBenefitCollectionItem--TextWrapper e1t707xg4">
														<p type="bold"
															class="css-cltgrd--PaymentBenefitCollectionItem--Text e1t707xg3">전북은행(JB카드)
															8% 즉시할인</p>
													</div>
												</div>
											</div>
											<div role="button" tabindex="0">
												<div
													...
													<div
														class="css-1j6vtio--PaymentBenefitCollectionItem--TextWrapper e1t707xg4">
														<p type="bold"
															class="css-cltgrd--PaymentBenefitCollectionItem--Text e1t707xg3">롯데카드
															8% 결제일 할인</p>
													</div>
												</div>
											</div>
											<div role="button" tabindex="0">
												<div
													...
													<div
														class="css-1j6vtio--PaymentBenefitCollectionItem--TextWrapper e1t707xg4">
														<p type="bold"
															class="css-cltgrd--PaymentBenefitCollectionItem--Text e1t707xg3">최대
															12개월 무이자 할부 가능</p>
													</div>
												</div>
											</div>
										...
										<div class="css-fw0beg--PaymentMethods--Wrapper e1piyscg0">
											<div
												class="css-116ga3z--PaymentMethodItem--Wrapper e1vqb7zb3">
												<div
													class="css-x4i4r9--PaymentMethodItem--Content e1vqb7zb2">
													<input type="radio"
														class="css-1ve8wdd--PaymentMethodItem--RadioButtonCircle--PaymentMethodItem--RadioButtonCircle e1vqb7zb1"
														name="paymentMethod" value="CREDIT_CARD" checked=""
														data-gtm-form-interact-field-id="4"> <label
														class="css-1d0zz7p--PaymentMethodItem--RadioButtonLabel e1vqb7zb0">신용/체크카드</label>
												</div>
											</div>
											<div
												class="css-13vtxn4--CreditCardSelectContent--Wrapper e1p85y4w2">
												<select
													class="css-p9ea29--CreditCardSelectContent--Select--CreditCardSelectContent--Select e1p85y4w1">
											...
											<div class="css-lkitu7--PaymentMethodItem--Wrapper e1vqb7zb3">
												<div
													class="css-x4i4r9--PaymentMethodItem--Content e1vqb7zb2">
													<input type="radio"
														class="css-kfke08--PaymentMethodItem--RadioButtonCircle e1vqb7zb1"
														name="paymentMethod" value="KAKAOPAY"
														data-gtm-form-interact-field-id="1"> <label
														class="css-1d0zz7p--PaymentMethodItem--RadioButtonLabel e1vqb7zb0">카카오페이</label>
													<div class="css-1sg2lsz">
														<img
															src="https://dffoxz5he03rp.cloudfront.net/icons/kakaopay_logo_v3.svg"
															class="css-1t940od">
													</div>
												</div>
											</div>
											<div class="css-lkitu7--PaymentMethodItem--Wrapper e1vqb7zb3">
												<div
													...
													<input type="radio"
														class="css-kfke08--PaymentMethodItem--RadioButtonCircle e1vqb7zb1"
														name="paymentMethod" value="PAYCO"
														data-gtm-form-interact-field-id="2"> <label
														class="css-1d0zz7p--PaymentMethodItem--RadioButtonLabel e1vqb7zb0">페이코</label>
													<div class="css-1sg2lsz">
														<img
															src="https://dffoxz5he03rp.cloudfront.net/icons/payco_logo_v3.svg"
															class="css-1t940od">
													</div>
												</div>
											</div>
											<div class="css-lkitu7--PaymentMethodItem--Wrapper e1vqb7zb3">
												<div
													...
													<input type="radio"
														class="css-kfke08--PaymentMethodItem--RadioButtonCircle e1vqb7zb1"
														name="paymentMethod" value="NAVERPAY"
														data-gtm-form-interact-field-id="3"> <label
														class="css-1d0zz7p--PaymentMethodItem--RadioButtonLabel e1vqb7zb0">네이버페이</label>
													<div class="css-1sg2lsz">
														<img
															src="https://dffoxz5he03rp.cloudfront.net/icons/naverpay_logo_v4.svg"
															class="css-1t940od">
													</div>
												</div>
											</div>
						...
						<div class="css-2ww8q5--FloatingContainer--Wrapper ebjak7v2">
							<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
								...
								<div class="css-1dc0kte--SectionContainer--Body exjt3m70">
									...
									<div class="css-1gf7fex--TotalPriceInfo--Container e1nkrbzh6">
										<div
											class="css-1a4bcnz--TotalPriceInfo--MainTextWrapper e1nkrbzh5">
											<span class="css-8lm0oe--TotalPriceInfo--Text e1nkrbzh4">총
												결제 금액</span>
											<div
												class="css-kz1cl5--TotalPriceInfo--PriceWrapper e1nkrbzh3">
												<span class="css-bla3vs--TotalPriceInfo--Price e1nkrbzh2"
													id="finalPrice" data-discounted-price="${discountedPrice}"
													data-total-nights="${totalNights}"> <fmt:formatNumber
														value="${reservation_price}" type="number" pattern="#,###" />원
												</span>
											</div>
										</div>
									</div>
									<div class="css-1ab299y--PaymentInfo--Wrapper e14vm5k10">
										<div class="css-1b76hqd--ProductNoticeInfo--Wrapper e17edfi26">
											<span
												class="css-1t882oi--ProductNoticeInfo--Text--ProductNoticeInfo--Button e17edfi24">상품에
												대해 알아두실 사항</span> <img
												class="css-pqepq8--ProductNoticeInfo--customIconStyle"
												src="https://dffoxz5he03rp.cloudfront.net/icons/ic_info_12x12_line_gray_500.svg"
												alt="icon">
										</div>
									</div>
								</div>
							...
							<div class="css-1yqvzrw--SectionContainer--Container exjt3m71">
								<div
									...
									<div class="css-1m5d5b0--SectionContainerHeader--Box e1o4ti5r3">
										<h2
											class="css-1espa7k--SectionContainerHeader--Title e1o4ti5r2">약관
											안내</h2>
									</div>
								</div>
								<hr class="css-73gmso">
													...
													<div class="css-1ofmo3h--TermCheckList--Wrapper efe16hw1">
														<div class="mrt-required-term">
															<span aria-hidden="true"
																class="css-1sgaj0v--CheckTerm--TermTitle e858sef0">개인정보
																수집 및 이용 동의 (필수)</span> <img class="css-xqn2lt"
														...
														<div class="mrt-required-term">
															<span aria-hidden="true"
																class="css-1sgaj0v--CheckTerm--TermTitle e858sef0">개인정보
																제공 동의 (필수)</span> <img class="css-xqn2lt"
																src="https://dffoxz5he03rp.cloudfront.net/icons/ic_arrowright_md_gray_300.svg"
																alt="detail arrow">
														</div>
														<div class="mrt-required-term">
															<span aria-hidden="true"
																class="css-1sgaj0v--CheckTerm--TermTitle e858sef0">개인정보
																국외 이전 동의 (필수)</span> <img class="css-xqn2lt"
																src="https://dffoxz5he03rp.cloudfront.net/icons/ic_arrowright_md_gray_300.svg"
																alt="detail arrow">
														</div>
													</div>
													<strong
														class="css-z6jvpf--TermCheckList--ConfirmStatement efe16hw2">위
														약관을 확인하였으며, 회원 본인은 약관 및 결제에 동의합니다.</strong>
												</div>
											</div>
											<div class="css-1rn2pqw--RefundPolicy--Container e1g30hl80">
												<div
													class="css-k4xfv6--RefundPolicy--Text--RefundPolicy--Title e1g30hl81">예약
													취소 규정</div>
												<div class="css-93wur2--RefundPolicy--Text e1g30hl82">
													<p class="css-1vct4yp--RenderMultiLineText--Line e4rbi9y0">${packageVo.start_date}까지
														취소 <br>(한국시간) : 전액 환불
													</p>
													<p class="css-1vct4yp--RenderMultiLineText--Line e4rbi9y0">${packageVo.end_date}
														이후 취소 <br>(한국시간) : 환불 불가
													</p>
												</div>
											</div>
							...
							<div class="css-13h99hv--PurchaseButton--Wrapper e1dwjai61">
								<span role="button" class="css-w0pi5v">
									<button type="button" class="mrt-button css-jgs6n"
										id="purchaseButton">
										<span class="css-1s4v6ia" id="purchaseButtonText"> <fmt:formatNumber
												value="${package_price}" type="number" pattern="#,###" />원
											결제하기
										</span>
									</button>
								</span>
