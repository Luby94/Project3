...
public class AirplaneTimeVo {
	...
	public AirplaneTimeVo(int airplane_idx, int airline_idx, String name, String logo, int departure_loc,
	...
	public String toString() {
		return "AirplaneTimeVo [airplane_idx=" + airplane_idx + ", airline_idx=" + airline_idx + ", name=" + name
				+ ", logo=" + logo + ", departure_loc=" + departure_loc + ", depCity1=" + depCity1 + ", depCityCode1="
				+ depCityCode1 + ", depCity2=" + depCity2 + ", depCityCode2=" + depCityCode2 + ", arrival_loc="
				+ arrival_loc + ", arrCity1=" + arrCity1 + ", arrCityCode1=" + arrCityCode1 + ", arrCity2=" + arrCity2
				+ ", arrCityCode2=" + arrCityCode2 + ", startTime1=" + startTime1 + ", endTime1=" + endTime1
				+ ", startTime2=" + startTime2 + ", endTime2=" + endTime2 + ", airplane_time_idx=" + airplane_time_idx
				+ ", adultCount=" + adultCount + ", childCount=" + childCount + ", infantCount=" + infantCount
				+ ", seatClass=" + seatClass + ", stype=" + stype + ", depDate=" + depDate + ", arrDate=" + arrDate
				+ ", ptype_idx=" + ptype_idx + ", stype_idx=" + stype_idx + ", durationhour=" + durationhour
				+ ", durationminute=" + durationminute + ", price=" + price + ", totalPrice=" + totalPrice + "]";
	}
